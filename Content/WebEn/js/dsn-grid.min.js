(window.$build = { swiper: [] }),
  ...
  (window.$scene = []),
  gsap.config({ autoSleep: 60, force3D: !1, nullTargetWarn: !1 }),
...
const dsnGrid = {
  ...
  activeScroll: function () {
    $effectScroll.isScroller() &&
      ($controller.scrollPos(function () {
        if (!$body.hasClass("locked-scroll"))
          return $effectScroll.getScrollbar().offset.y;
      }),
      $effectScroll.getListener(function () {
        $controller.update();
      }));
  ...
  getHeightScroll: function () {
    return window.Scrollbar.get(document.querySelector("#dsn-scrollbar"))
      ? $effectScroll.getScrollbar().limit.y - document.body.scrollHeight
      : document.body.scrollHeight - $wind.height();
  },
  ...
  executeStyle: function () {
    ...
    e
      ? ("dark" === e && $body.hasClass("v-dark")) || this.changeColor()
      : this.setStyle($body.hasClass("v-dark") ? "dark" : "light");
  },
  changeColor: function () {
    const e = $(".v-dark"),
      t = $(".v-light");
    $body.toggleClass("v-dark"),
      e.removeClass("v-dark").addClass("v-light"),
      t.addClass("v-dark").removeClass("v-light");
  },
      ...
      (e += ""),
      {
        crypt: function () {
          ...
          for (let i, o = 0; o < e.length; o++)
            (i = e.charCodeAt(o) + t), (n += String.fromCharCode(i));
          return n;
        },
        decrypt: function () {
          let n = "";
...
(window.$dsnOption = { heightScroll: dsnGrid.getHeightScroll() }),
